...
Type *surrender* to surrender and admit defeat`
	    ...
	    CynthiaAI.sendText(m.chat, `Setelan telah dikirimkan ke chat masing-masing. Silahkan pilih setelan yang Anda inginkan di chat tersebut selama 7 detik. atau Anda bisa langsung ke chat dengan mengklik tautan berikut ( https://wa.me/${botNumber.split`@`[0]} )`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) CynthiaAI.sendText(roof.p, `Silahkan Pilih Setelah Anda\n1. Batu\n2. Kertas\n3. Scissors️`, m)
	    if (!roof.pilih2) CynthiaAI.sendText(roof.p2, `Please Select \n1. Batu\n2. Kertas\nGunting`, m)
	    ...
	    CynthiaAI.sendText(roof.asal, `Permainan Berakhir ${tie ? '\nSERIES' : ''}
