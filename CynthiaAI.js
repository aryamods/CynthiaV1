...
module.exports = CynthiaAI = async (CynthiaAI, m, chatUpdate, store) => {
    ...
    return await CynthiaAI.relayMessage(chatId, generate.message, { messageId: generate.key.id })
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./AImedia/theme/cheemspic.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
	    const frpayment = {
	key: {
 ...
 if (db.data.chats[m.chat].antibot) {
    ...
    return CynthiaAI.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].badword) {
			...
			CynthiaAI.sendMessage(from, {text:`「 *KATA KASAR TERDETEKSI* 」\nMengingat fitur Anti Kata Kasar telah diaktifkan oleh Admin, Cynthia tidak memiliki pilihan lain selain menghapusnya.`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
               }
            }
        }
        //autosticker
...
if (XeonTheCreator) return replygcxeon(bvl)
			...
			CynthiaAI.sendMessage(from, {text:`「 *TAUTAN GRUP TERDETEKSI* 」\nMengingat fitur Anti Kata Kasar telah diaktifkan oleh Admin, Cynthia tidak memiliki pilihan lain selain menghapusnya.`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
            }
        }
...
if (XeonTheCreator) return replygcxeon(bvl)
			...
			CynthiaAI.sendMessage(from, {text:`「 *TAUTAN TERDETEKSI* 」\nMengingat fitur Anti Link telah diaktifkan oleh Admin, Cynthia tidak memiliki pilihan lain selain menghapusnya.`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
            }
        }
        //afk
...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(xeonverifieduser, null, 2))
        ...
        switch (isCommand) {
            ...
            case 'sim': {
                ...
                await fsx.copy(delb, './AImedia/theme/cheemspic.jpg')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
            ...
            case 'sgm': {
                if (!XeonTheCreator) return XeonStickOwner()
                let delb = await CynthiaAI.downloadAndSaveMediaMessage(quoted)
                await fsx.copy(delb, './AImedia/theme/Cheems-bot.mp4')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
...
if (typemenu === 'v1') {
                    CynthiaAI.sendMessage(m.chat, {
                        image: fs.readFileSync('./AImedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    CynthiaAI.sendMessage(m.chat, {
                        video: fs.readFileSync('./AImedia/theme/Cheems-bot.mp4'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
