...
Type *surrender* to surrender and admit defeat`
	    ...
	    CynthiaAI.sendText(m.chat, `Setelan telah dikirimkan ke chat masing-masing. Silahkan pilih setelan yang Anda inginkan di chat tersebut selama 5 detik. atau Anda bisa langsung ke chat dengan mengklik tautan berikut ( https://wa.me/${botNumber.split`@`[0]} )`, m, { mentions: [roof.p, roof.p2] })
